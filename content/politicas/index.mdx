...
Versão 0.6, de 26 de agosto de 2026, ainda como **proposta para avaliação**. Esta versão revisa a fundamentação jurídica da versão 0.5 e mantém as regras de conduta que ela estabeleceu. O registro do que mudou está no [Anexo D](#anexo-d-registro-de-alterações-da-versão-06).

Trechos entre colchetes, como `[definir prazo]` ou `[definir canal]`, marcam pontos que dependem de definição final antes da aprovação pela Diretoria.
</Callout>

## Como ler esta política

Cada item é seguido de um bloco de fundamento que indica de onde a regra vem. Os marcadores abaixo separam obrigação legal de decisão da empresa. A distinção é deliberada: perguntado onde a lei manda determinada coisa, o documento precisa poder responder que a lei manda, que a ANPD orienta ou que foi a Elinsa que escolheu adotar.

| Marcador | Significado |
| --- | --- |
| **[LEGAL]** | Obrigação prevista em lei ou regulamento brasileiro em vigor. |
| **[REGULATÓRIO]** | Orientação ou entendimento manifestado pela ANPD. Não tem força de lei, mas indica como a autoridade interpreta a norma. |
| **[REFERÊNCIA]** | Norma estrangeira, padrão técnico, estudo ou caso público usado como parâmetro. Sem efeito vinculante no Brasil. |
| **[INTERNO]** | Regra que a Elinsa escolheu adotar. Em vários pontos é mais restritiva que a exigência legal. |

<Callout type="info" title="Por que a distinção importa">
Uma regra interna não fica mais fraca por ser identificada como interna. Fica mais difícil de contestar, porque deixa de depender de uma leitura ampliada da lei que o interlocutor pode questionar. Regras marcadas como **[INTERNO]** são igualmente obrigatórias na Elinsa e seu descumprimento sujeita o infrator às medidas do item 24.
</Callout>
...
Consentimento do titular, autorização de uso de imagem e autorização do contratante são institutos distintos, com fundamento legal e alcance próprios. Nenhum supre o outro. Onde esta política exige uma delas, exige aquela especificamente nomeada — e nem todo tratamento de dados pessoais depende de consentimento, porque a LGPD prevê outras nove bases legais no art. 7º.
</Callout>
...
<Callout type="info" title="Fundamento">
**[INTERNO]** A escala e o enquadramento de cada uso são definição da Elinsa. A hipótese "Vedado" não descreve ilicitude declarada em lei: descreve o que a empresa não autoriza em nenhuma circunstância, ressalvado o item 17.1, cuja gravidade tem também natureza penal.
...
**19.4.** Código produzido com auxílio de IA é tratado como código de autoria de quem o incorporou ao sistema, que responde por ele perante a empresa. Trecho que o responsável não consiga explicar não entra em sistema que trate informação confidencial ou restrita.
...
<Callout type="info" title="Fundamento">
**[INTERNO]** O registro prévio junto à TI e os requisitos do item 19.3 são controle de engenharia da Elinsa e alcançam sistemas que não tratam dado pessoal algum. Nenhuma norma exige esse registro. A regra do item 19.4 é atribuição interna de responsabilidade técnica: define quem responde pelo código perante a empresa e não decide questão de titularidade de direitos autorais, tratada no item 21.3.

**[LEGAL]** Quando o sistema tratar dados pessoais, aplicam-se a LGPD, art. 49, que exige que os sistemas sejam estruturados de forma a atender aos requisitos de segurança e aos padrões de boas práticas e governança; o art. 46, § 2º, que impõe a observância dessas medidas desde a concepção até a execução; e o art. 37, que obriga à manutenção de registro das operações de tratamento.
</Callout>
...
<Callout type="warning" title="Item 24.4 — O que segue são consequências para a empresa">
As hipóteses abaixo descrevem consequências que a **Elinsa** pode suportar, apuradas em processo próprio contra a empresa e com contraditório. Estão registradas para que os destinatários desta política conheçam o que está em jogo.

Nenhuma delas é sanção aplicável ao colaborador. A medida cabível a quem descumpre esta política é a do item 24.1, e somente ela.
</Callout>
...
## Anexo D. Registro de alterações da versão 0.6

Esta versão corrige a fundamentação jurídica da versão 0.5. **Nenhuma regra de conduta foi flexibilizada.** O que mudou foi a atribuição correta de cada regra à sua origem — lei, orientação regulatória, referência internacional ou decisão da empresa.

| Item | O que mudou |
| --- | --- |
| Geral | Introdução dos marcadores **[LEGAL]**, **[REGULATÓRIO]**, **[REFERÊNCIA]** e **[INTERNO]** em todos os blocos de fundamento |
| 1.4 | Novo. Declara expressamente que a política combina obrigação legal e regra própria |
| 2.5 | Novo. Exige que a política seja incorporada aos contratos de terceiros para vinculá-los |
| 3 | Definições novas de consentimento, autorização de uso de imagem e autorização do contratante, que a v0.5 tratava de forma indistinta. Perfilamento passa a ser definido "para fins desta política" |
| 5 | O Comitê deixa de ser fundamentado nos arts. 38 e 41 da LGPD, que não o exigem, e passa a ser apresentado como estrutura interna amparada no art. 50 |
| 6.3 | Retirada a afirmação de que recurso novo de IA configura mudança de finalidade do art. 9º, § 2º. A análise passa a ser contextual |
| 7.4 | Novo. Declara que a escala Pública–Interna–Confidencial–Restrita é interna e não corresponde às categorias da LGPD |
| 8.3 e 18 | Corrigido o uso do art. 20 da LGPD, que assegura direito de revisão e não impõe supervisão humana prévia nem proíbe decisão automatizada |
| 9.2 | Novo. Declara que os níveis da matriz não são categorias legais de risco |
| 10 | Retirada a afirmação de que a ausência de contrato viola o art. 7º, VII, do Marco Civil. Fundamento reancorado nos arts. 46 e 47 da LGPD, em cláusulas contratuais e na Lei nº 9.610/1998 |
| 11 | Substituída a formulação "sem contrato não há conformidade" por descrição do que a ausência de contrato efetivamente impede |
| 12.5 | Novo. Fixa os parâmetros de todo monitoramento e atribui a verificação ao Encarregado |
| 13.5 e 13.6 | O direito de eliminação passa a ser qualificado ("quando cabível"), com as ressalvas do art. 16 da LGPD e o dever de resposta fundamentada |
| 14.2 e 14.4 | A autorização do contratante deixa de ser apresentada como exigência legal geral e passa a decorrer do contrato ou da consulta prévia quando ele for silente |
| 16.5 | A autorização de admissão deixa de ser declarada inservível para IA em qualquer hipótese; passa a ser insuficiente quando não abranger claramente essa finalidade |
| 17.1 | Fundamento penal do ECA (art. 241-C e correlatos) passa a ser a base principal. A Lei nº 15.211/2025 é mantida com a ressalva de que seus deveres se dirigem a provedores |
| 20 | Acrescentada a NR-10 como norma efetivamente aplicável, ao lado do EU AI Act como referência |
| 22.2 | O prazo de resposta do Comitê é qualificado como prazo-alvo de gestão |
| 23.2 e 23.6 | A comunicação externa passa a remeter expressamente à regulamentação da ANPD, distinguindo-a do prazo interno de comunicação |
| 24 | **Reescrito.** Separa a medida disciplinar aplicável ao colaborador (24.1) das consequências suportadas pela empresa (24.4), corrige a equiparação operador–controlador e esclarece que as sanções do ECA Digital se dirigem a provedores abrangidos por aquela lei |
| 26.1 e 26.6 | "Anistia" passa a "janela de regularização voluntária", com ressalva expressa quanto a ilícitos civis e penais e a obrigações de comunicação já existentes |
| Anexo B | Coluna Natureza e inclusão de Lei nº 9.610/1998, tipos penais do ECA, NR-10 e regulamentação da ANPD |

<Callout type="warning" title="Pendências para a revisão do Jurídico">
As referências a documentos técnicos da ANPD (itens 9.2, 15 e Anexo B) e a Resolução CD/ANPD nº 15/2024 devem ser conferidas quanto à identificação exata e à vigência na data de aprovação. O mesmo vale para a verificação, prevista no item 17.6, sobre se alguma aplicação da Elinsa atrai as obrigações da Lei nº 15.211/2025 dirigidas a provedores.
</Callout>

...
<DownloadableFile href="https://file.elinsadobrasil.com.br/compressed/sap.7z" fileName="sap.tar" description="Arquivo de instalação do SAP Logon 64" type="application/x-7z-compressed" title="SAP"/>

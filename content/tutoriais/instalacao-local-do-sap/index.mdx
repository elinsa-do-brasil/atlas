...
1. Abra o **Prompt de Comando** ou o **PowerShell**. É obrigatório executar como **administrador**.
...
<DownloadableFile href="https://amperelinsa-my.sharepoint.com/personal/ytalo_queiroz_grupoamperelinsa_com/_layouts/15/download.aspx?UniqueId=05805a84%2Da3ad%2D431d%2D968c%2D8e44bb4a1fc2" filename="sap.tar" description="Arquivo de instalação do SAP Logon 64" type="application/x-tar" />
...
Se o Windows não extrair arquivos `.tar` nativamente, instale o **NanoZip**, que é gratuito na Microsoft Store.
